...
class StructureDetector:
    ...
    def detect_messy_text_structure(self, raw_text: str) -> str:
        ...
        """
        prompt = f"""
        Analyze the following exam paper text and identify the pattern for questions and options.
        Text Sample:
        {raw_text[:1000]}
        
        Describe the pattern (e.g., 'Questions start with "Q." and options are on new lines') 
        and provide a regex-like logic for extraction.
        """
